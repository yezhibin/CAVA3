...
class _Misc(_BuiltInBase):
    ...
    def keylog(self, message):
        """In the Robot Excel Report, log the given message used for the key info.
        message:key info.
        Examples:
        | Keylog | Hello, world!        |# test purpose   |
        """
        logger.write(message, "INFO", False)
