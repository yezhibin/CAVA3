...
_pkg_config = {
    ...
    'default_mod_dir':    '/usr/local/lib/python3.7/site-packages',
    'default_sip_dir':    '/usr/local/share/sip',
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/usr/local/include/python3.7m',
    'py_inc_dir':         '/usr/local/include/python3.7m',
    'py_lib_dir':         '/usr/local/lib/python3.7/config',
    'py_version':         0x030703,
    'qt_framework':       0,
    'sip_bin':            '/usr/local/bin/sip',
    'sip_config_args':    '',
    'sip_inc_dir':        '/usr/local/include/python3.7m',
    'sip_module_dir':     '/usr/local/lib/python3.7/site-packages',
    'sip_root_dir':       '/usr/local/lib/python3.7/site-packages',
